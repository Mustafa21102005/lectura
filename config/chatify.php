...
return [
    ...
    */
    'routes' => [
        ...
        'middleware' => ['web', 'auth', 'role:teacher|parent'], // chat is only for parents and teachers
    ...
    */
    'attachments' => [
        ...
        'allowed_images' => (array) ['png', 'jpg', 'jpeg', 'gif', 'webp', 'svg'],
