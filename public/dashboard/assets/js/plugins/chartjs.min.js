...
!(function (t, e) {
        ...
        for (d = 0; d <= c; ++d)
            ((u = o[(r + (p ? c - d : d)) % a]),
                u.skip ||
                    ...
                    (f = u)));
        return (
            l && ((u = o[(r + (p ? c : 0)) % a]), h(t, f, u, p, s.stepped)),
            !!l
        );
    }
    function bo(t, e, i, n) {
    ...
    class ps extends Oi {
        ...
        _resolveAnimations() {
            ...
            const i = t._chart,
                ...
                s = new bi(t._chart, o);
            return (
                o._cacheable && (t._cachedAnimations = Object.freeze(s)),
                s
            );
        }
        getContext() {
    ...
    function Bs(t, e, i) {
        let n, o, s, a;
        if (i)
            ((n = Math.floor(e)), (o = Math.ceil(e)), (s = t[n]), (a = t[o]));
        else {
            const i = ee(t, e);
