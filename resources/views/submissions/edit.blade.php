...
@section('page_header', 'Edit Submission')
                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                            <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Edit Submission</h4>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" method="POST" action="{{ route('submissions.update', $submission) }}"
                            ...
                            <div class="input-group input-group-outline my-3">
                                <textarea id="remarks" name="remarks" class="form-control" rows="3" placeholder="Remarks">{{ old('remarks', $submission->remarks) }}</textarea>
                            </div>
                            ...
                            <div class="my-3">
                                <h6 class="text-center">Existing Files</h6>
                            ...
                            <div class="text-center">
                                ...
                                <x-cancel-button :route="route('student.submissions.index')" />
                            </div>
                        </form>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    fetch(`/submissions/media/${mediaId}`, {
                            method: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': '{{ csrf_token() }}',
